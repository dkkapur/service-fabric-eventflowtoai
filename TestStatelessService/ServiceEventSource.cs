...
{
    [EventSource(Name = "dekapur-MonitoringDemo-TestStatelessService")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        private const int MetricEventId = 10;
        [Event(MetricEventId, Level = EventLevel.Informational, Message = "{0}")]
        public void ReportMetric(double requestTime)
        {
            WriteEvent(MetricEventId, requestTime);
        }
